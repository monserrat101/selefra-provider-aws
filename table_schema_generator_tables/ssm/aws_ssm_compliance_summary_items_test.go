...
func buildComplianceSummaryItems(t *testing.T, ctrl *gomock.Controller) aws_client.AwsServices {
...
func TestComplianceSummaryItems(t *testing.T) {
	...
	aws_client.MockTestHelper(t, table_schema_generator.GenTableSchema(&TableAwsSsmComplianceSummaryItemsGenerator{}), buildComplianceSummaryItems, aws_client.TestOptions{})
