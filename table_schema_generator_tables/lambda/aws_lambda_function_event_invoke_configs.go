...
func (x *TableAwsLambdaFunctionEventInvokeConfigsGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("maximum_event_age_in_seconds").ColumnType(schema.ColumnTypeBigInt).
			Extractor(column_value_extractor.StructSelector("MaximumEventAgeInSeconds")).Build(),
