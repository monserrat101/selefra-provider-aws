...
func (x *TableAwsElasticacheEngineVersionsGenerator) GetColumns() []*schema.Column {
	return []*schema.Column{
		...
		table_schema_generator.NewColumnBuilder().ColumnName("cache_engine_description").ColumnType(schema.ColumnTypeString).
			Extractor(column_value_extractor.StructSelector("CacheEngineDescription")).Build(),
		table_schema_generator.NewColumnBuilder().ColumnName("cache_engine_version_description").ColumnType(schema.ColumnTypeString).
			Extractor(column_value_extractor.StructSelector("CacheEngineVersionDescription")).Build(),
